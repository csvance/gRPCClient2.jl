...
# original file: /home/cvance@medicalmetrics.local/PycharmProjects/gRPCClient2.jl/test/proto/test.proto (proto3 syntax)
...
) = gRPCClient{TestRequest, false, TestResponse, false}(
...
TestService_TestServerStreamRPC_Client(
	...
	max_send_message_length = 4*1024*1024,
	max_recieve_message_length = 4*1024*1024,
) = gRPCClient{TestRequest, false, TestResponse, true}(
...
TestService_TestClientStreamRPC_Client(
	...
	max_send_message_length = 4*1024*1024,
	max_recieve_message_length = 4*1024*1024,
) = gRPCClient{TestRequest, true, TestResponse, false}(
...
TestService_TestBidirectionalStreamRPC_Client(
	...
	max_send_message_length = 4*1024*1024,
	max_recieve_message_length = 4*1024*1024,
) = gRPCClient{TestRequest, true, TestResponse, true}(
